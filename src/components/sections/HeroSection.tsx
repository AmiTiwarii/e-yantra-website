...
function HeroSection() {
  return (
    <div className="w-full h-screen flex flex-col md:flex-row relative pb-10 mb-10">
      <div className="w-full md:w-[40%] h-64 md:h-full gap-4 overflow-hidden flex md:ml-8">
      ...
      <div className="relative w-full md:w-[60%] flex items-center overflow-hidden py-8 md:py-0">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl">
            ...
            <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold text-black mb-6 leading-tight">
              ...
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-blue-200">Robotics</span>
              <span> and </span>
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-800 to-blue-100">
                Automation
              </span>
            </h1>
            <p className="text-lg sm:text-xl text-blue-300 mb-8 max-w-2xl">
              Pushing the boundaries of technology through cutting-edge research, innovative solutions, and
      ...
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-full h-[50px] bg-gradient-to-l from-red-600 to-blue-500 shadow-custom z-0 rotate-[178deg]"></div>
    </div>
  )
}
